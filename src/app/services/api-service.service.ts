...
export class ApiServiceService {
  ...
  studentLogin(loginInfo: Login) {
    ...
    return this._http
      .post(this.baseURL + 'login', JSON.stringify(loginInfo), { headers })
  ...
  getAllStudents(page: number, size: number): any {
    ...
    return this._http.get(this.baseURL + 'students', { headers, params }).pipe(catchError(this.handleError));
  }
}
